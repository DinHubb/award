<template>
  <section id="faq" class="relative pb-16 pt-20 md:py-24 overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
      ...
      <!-- Contact Form -->
      <div
        class="bg-black/40 backdrop-blur-sm rounded-3xl p-4 sm:p-8 lg:p-10 border-2 border-zinc-800"
        data-aos="fade-up"
        data-aos-delay="200"
      >
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <button
            ...
            class="relative w-full px-4 py-3 sm:px-6 sm:py-4 rounded-xl font-semibold text-lg shadow-lg transition-all duration-300 overflow-hidden group"
            :class="
              !isSubmitting
...
const questions: FAQQuestion[] = [
  {
    ...
    answer: {
      ru: "В голосовании может принять участие любой житель Республики Таджикистан старше 16 лет. Для участия необходимо зарегистрироваться на платформе и подтвердить свой номер телефона — это обеспечивает достоверность и уникальность каждого голоса.",
      tj: "Дар овозгирӣ ҳар як сокини Ҷумҳурии Тоҷикистон, ки синнаш аз 16 сол зиёд аст, метавонад иштирок кунад. Барои иштирок зарур аст, ки дар платформа сабти ном шавед ва рақами телефонатонро тасдиқ кунед — ин ҳақиқат ва беназирии ҳар як овозро таъмин мекунад.",
    },
  },
  {
    question: {
    ...
    answer: {
      ru: "Нет. Один уникальный участник может проголосовать только два раза:<br>✓ один раз — за одного мобильного оператора;<br>✓ один раз — за одного интернет-провайдера.<br><br>Система автоматически соотносит номер телефона и голос, отданный за участника и учитывает голос только один раз в каждой категории, обеспечивая честность и прозрачность голосования.",
      tj: "Не. Як иштирокчии беназир метавонад танҳо ду маротиба овоз диҳад:<br>✓ як маротиба — барои як оператори мобилӣ;<br>✓ як маротиба — барои як провайдери интернет.<br><br>Система ба таври худкор рақами телефон ва овози додашударо барои иштирокчӣ мутобиқ мекунад ва овозро танҳо як маротиба дар ҳар категория ба инобат мегирад, ки ҳалолӣ ва шаффофияти овозгириро таъмин мекунад.",
    },
  },
  {
    question: {
    ...
    answer: {
      ru: "Победители определяются на основе оценок пользователей по ряду ключевых критериев качества услуг.<br><br>При голосовании учитываются следующие показатели:<br>• качество связи;<br>• скорость и стабильность интернета;<br>• стоимость и доступность услуг;<br>• покрытие сети;<br>• качество обслуживания и поддержки клиентов.<br><br>Каждая оценка преобразуется в балл, а итоговый результат формируется из общей суммы баллов по всем критериям.<br><br>Таким образом обеспечивается объективная, прозрачная и сбалансированная система определения победителей.",
      tj: "Ғолибон дар асоси баҳогузориҳои корбарон аз рӯи як қатор меъёрҳои калидии сифати хидматрасонӣ муайян карда мешаванд.<br><br>Ҳангоми овозгирӣ нишондиҳандаҳои зерин ба инобат гирифта мешаванд:<br>• сифати алоқа;<br>• суръат ва устувории интернет;<br>• арзиш ва дастрасии хидматрасониҳо;<br>• пӯшиши шабака;<br>• сифати хидматрасонӣ ва дастгирии муштариён.<br><br>Ҳар баҳогузорӣ ба балл табдил дода мешавад ва натиҷаи ниҳоӣ аз маҷмӯи умумии баллҳо аз рӯи ҳамаи меъёрҳо ташаккул меёбад.<br><br>Ба ин тариқа системаи объективӣ, шаффоф ва мутавозини муайян кардани ғолибон таъмин карда мешавад.",
    },
  },
  {
    question: {
    ...
    answer: {
      ru: "Голосование проходит с 24 ноября по 15 декабря 2025 года.<br><br>Итоговые результаты будут объявлены на торжественной церемонии награждения, которая состоится в конце 2025 года.<br><br>Кроме того, на сайте Премии доступны интерактивные диаграммы, где вы можете видеть актуальную динамику голосования в режиме реального времени.",
      tj: "Овозгирӣ аз 24 ноябр то 15 декабри соли 2025 гузаронида мешавад.<br><br>Натиҷаҳои ниҳоӣ дар маросими ҷашнии мукофотдиҳӣ эълон мешаванд, ки дар охири соли 2025 баргузор мешавад.<br><br>Илова бар ин, дар сомонаи Мукофот диаграммаҳои интерактивӣ дастрасанд, ки дар он шумо метавонед динамикаи воқеии овозгириро дар реҷаи вақти воқеӣ бинед.",
    },
  },
  // {
  //   question: {
